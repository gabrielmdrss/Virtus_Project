...
int main(void) {
	...
	ssd1306_Init();												// SSD1306 Function for display Initialization
	MPU6050_Init();												// Auxiliary function for MPU6050 Initialization
	HAL_TIM_Base_Start(&htim2);									// Starts the TIMER2 for the feature of ultrasonic sensor
